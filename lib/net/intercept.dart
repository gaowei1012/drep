...
class AuthInterceptor extends Interceptor {
  ...
  onRequest(RequestOptions options) {
    String accessToken = SpUtil.getString(Contant.access_Token);
...
class TokenInterceptor extends Interceptor {
  Future<String> getToken() async {
    ...
    params["refresh_token"] = SpUtil.getString(Contant.refresh_Token);
    try {
  ...
  Future onResponse(Response response) async {
    ...
    if (response != null && response.statusCode == ExceptionHandle.unauthorized) {
      ...
      SpUtil.putString(Contant.refresh_Token, accessToken);
      ...
      if (accessToken != null) {
        ...
        try {
          Log.e("---------重新请求--------");
          var response = await _tokenDio.request(
            request.path,
            data: request.data,
...
class AdapterInterceptor extends Interceptor {
  ...
  static const String DEFAULT = "\"无法返回信息\"";
